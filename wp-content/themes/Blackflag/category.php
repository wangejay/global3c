...
<div id="main" <?php if ( $category_post_size == 'three-thirds' ){echo 'class="no-sidebar"';}if ( !is_active_sidebar('catsidebar')){echo 'class="no-sidebar"';}?>>
	<div id="primary">
		<div class="widget-title">
			<h1>
				<?php echo get_option('bf_word_before_category'); ?>
...
?>
	...
	<div id="fullwidth">
		<div class="home-widget three-thirds">
			<?php if(get_option('bf_category_popular_title')) { ?>
			<h3>
				<span class="widget-title">
				<?php echo get_option('bf_category_popular_title'); ?>
				</span>
			</h3>
			<?php } ?>
			<?php bf_popular_posts();?>
		</div>
